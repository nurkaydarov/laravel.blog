...
<script type="text/javascript"  src="{{ asset('assets/admin/ckeditor5/config.js') }}"></script>
<script type="text/javascript"  src="{{ asset('assets/admin/ckeditor5/build/ckeditor.js') }}"></script>
